...
class Classifier:
    def __init__(self, bucketPrefix, testBucketNumber, dataFormat):
        ...
        #
        # the original author made a mistake here, 
        # we need to convert either count or total to float type first, 
        # or self.prior[category] will always be zero.
        #
    ...
    def classify(self, itemVector, numVector):
        ...
        # print(results) # all prob equals to zero, something is wrong
...
def tenfold(bucketPrefix, dataFormat):
    ...
    for i in range(1, 11):
        ...
        # put all returned results from ten buckets together
